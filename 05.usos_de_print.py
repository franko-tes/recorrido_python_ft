...
print("--06.Impresion de variables--")
...
print("--07.Uso de formato con f-strings--")
...
print("--08.Uso de formato con format--")
...
print("--08.Impresion con formato especifico--")
...
print("--09.Salida de linea y caracteres especiales--")
